...
//
// @id = ch.banana.ch.invoice.template3
// @api = 1.0
// @pubdate = 2018-01-15
// @publisher = Banana.ch SA
// @description = Invoice with quantity and unit price columns (ISR) - style 3
// @description.it = Fattura con colonne quantità e prezzo unitario (PVR) - stile 3
// @description.de = Rechnung mit Menge und Einheitspreisspalten (ESR) - Stil 3
// @description.fr = Facture avec colonnes de quantité et prix unitaire (BVR) - style 3
// @description.nl = Factuur met hoeveelheids en eenheidsprijskolommen (ISR) - stijl 3
// @description.en = Invoice with quantity and unit price columns (ISR) - style 3
// @doctype = *
