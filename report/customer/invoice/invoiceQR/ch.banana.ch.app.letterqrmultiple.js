...
function setTexts(language) {
  ...
  if (language === 'it') {
    ...
    texts.sender_address = "Adresse de l'expéditeur (Payable à)";
    texts.sender_address_from_accounting = "Utiliser l'adresse de la comptabilité";
    texts.sender_address_name = 'Nom';
    texts.sender_address_address = 'Adresse';
    texts.sender_address_house_number = 'Numéro d’immeuble';
    ...
    texts.print_begin_text = 'Begin text';
    texts.print_final_text = 'Final text';
