...
// @id = ch.banana.ch.invoice.template3.test
// @api = 1.0
// @pubdate = 2018-01-15
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.ch.invoice.template3.js>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.ch.invoice.template3.js
// @timeout = -1
...
ReportInvoiceTemplate3.prototype.testReport = function() {
  ...
  Test.logger.addComment("Test ch.banana.ch.invoice.template3.js");
