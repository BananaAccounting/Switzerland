...
// @description.de = Rechnung mit Summenspalte (ESR)
// @description.fr = Facture avec total colonne (BVR)
// @description.nl = Factuur met totale kolom (ISR)
// @description.en = Invoice with total column (ISR)
// @doctype = *
