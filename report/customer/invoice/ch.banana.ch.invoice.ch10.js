...
// @description = [CH10] Style 10: Customizable Invoice Layout (BETA)
// @description.it = [CH10] Stile 10: Layout fattura personalizzabile (BETA)
// @description.de = [CH10] Stil 10: Anpassbares Rechnungslayout (BETA)
// @description.fr = [CH10] Style 10: Mise en page personnalisable de la facture (BETA)
// @description.en = [CH10] Style 10: Customizable Invoice Layout (BETA)
// @doctype = *
...
function print_isr(jsonInvoice, report, repStyleObj, userParam) {
  ...
  */
  ...
  printisr_account(jsonInvoice, pvrForm, repStyleObj, userParam);
...
function printisr_account(jsonInvoice, report, repStyleObj, userParam) {
  /*
