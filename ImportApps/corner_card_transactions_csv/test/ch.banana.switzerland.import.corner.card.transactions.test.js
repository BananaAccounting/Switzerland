...
// @id = ch.banana.switzerland.import.corner.card.transactions.test
// @api = 1.0
// @pubdate = 2021-03-08
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.switzerland.import.corner.card.transactions.test>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
...
Test.registerTestCase(new TestImportCornerCardTrans());

// Here we define the class, the name of the class is not important
function TestImportCornerCardTrans() {
}
