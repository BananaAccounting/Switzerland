...
// @id = ch.banana.switzerland.import.nkb
// @api = 1.0
// @pubdate = 2025-04-02
...
function exec(string, isTest) {
   ...
   // Nidwaldner Format, this format works with the header names.
   var nidwaldnerFormat = new NidwaldnerFormat();
   if (nidwaldnerFormat.match(transactionsData)) {
      transactions = nidwaldnerFormat.convert(transactionsData);
 ...
 * Nidwaldner Format
 *
 * Kontoauszug bis: 31.12.2024 ;;;
 * ;;;
 * Kontonummer: 123.123-123;;;
 * Bezeichnung: Betriebskredit;;;
 * Saldo: CHF 123456.74;;;
 * ;;;
 * XXX S�rl;;;
 * Salzburg St 25;;;
 ...
 * 31.12.2024;Test;-165.6;31.12.2024
 * 31.12.2024;Test;-5314.35;31.12.2024
 * 31.12.2024;Test;-15000;31.12.2024
 * 31.12.2024;Test;9623.5;31.12.2024
 * 30.12.2024;Test;-390.1;31.12.2024
*/
function NidwaldnerFormat() {
