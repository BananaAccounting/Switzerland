...
// @id = ch.banana.switzerland.import.bancastato.test
// @api = 1.0
// @pubdate = 2022-10-17
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.switzerland.import.bancastato.test>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.switzerland.import.bancastato.sbaa/import.utilities.js
// @includejs = ../ch.banana.switzerland.import.bancastato.sbaa/ch.banana.switzerland.import.bancastato.js
// @timeout = -1

// Register test case to be executed
Test.registerTestCase(new TestImportBancaStato());

// Here we define the class, the name of the class is not important
function TestImportBancaStato() {
}
