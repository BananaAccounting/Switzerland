...
//
// @id = ch.banana.apps.import.soba
// @api = 1.0
// @pubdate = 2018-07-10
// @publisher = Banana.ch SA
// @description = Bank SoBa (*.csv)
   ...
   * - Number decimal separator must be "." and there should be no thousand separator */
   convertionParam.rowConverter = function(inputRow) {
      ...
      *    Create this fields so that you can use-it in the postprocessing function */
      ...
      convertedRow["Date"] = Banana.Converter.toInternalDateFormat(inputRow["Datum"], "dd.mm.yy");
      convertedRow["DateValue"] = Banana.Converter.toInternalDateFormat(inputRow["Valuta"], "dd.mm.yy");
      convertedRow["Description"] = inputRow["Buchungstext"];
      ...
      *  we already have negative amounts in Betrag and don't need the to fill the column Expenses*/
      convertedRow["Income"] = Banana.Converter.toInternalNumberFormat(inputRow["Gutschrift"], ".");
      convertedRow["Expenses"] = Banana.Converter.toInternalNumberFormat(inputRow["Belastung"], ".");
      /** END */
