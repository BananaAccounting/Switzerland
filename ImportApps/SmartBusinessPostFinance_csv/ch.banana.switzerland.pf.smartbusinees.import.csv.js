...
// @description = SmallInvoice - Import data .csv
// @description.it = SmallInvoice - Importa dati .csv
// @description.en = SmallInvoice - Import data .csv
// @description.de = SmallInvoice - Daten importieren .csv
// @description.fr = SmallInvoice - Importer données .csv
// @doctype = 400.400
// @encoding = utf-8
// @task = import.rows
