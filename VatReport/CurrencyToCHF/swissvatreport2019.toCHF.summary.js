...
//
// @id = ch.banana.addon.swissvatreport2019.toCHF.summary
// @api = 1.0
// @pubdate = 2019-03-12
// @publisher = Banana.ch SA
// @description = Swiss VAT Report 2019, Summary currency to CHF (Beta)
// @task = app.command
// @doctype = 100.130.*
// @docproperties = 
// @outputformat = none
...
function loadParam(banDoc, startDate, endDate) {
    param = {
        "reportName" : "Swiss VAT Report 2019, Summary currency to CHF (Beta)",
        "bananaVersion" : "Banana Accounting 9",
        "scriptVersion" : "script v. 2019-03-12",
        "startDate" : startDate,
        "endDate" : endDate,
...
function addHeader(report, param) {
    ...
    pageHeader.addParagraph("VAT Report 2019, Summary currency to CHF", "heading");
