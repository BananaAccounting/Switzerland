...
function settingsVatDialog(vatCHObject) {
   ...
   typeOfSubmissionComboBox.currentIndex = parseInt(vatCHObject.param.xml.typeOfSubmission)-1;
   formOfReportingComboBox.currentIndex = parseInt(vatCHObject.param.xml.formOfReporting)-1;
